...
cc -Werror -Wall -Wextra -I include -I /core -c src/main.c -o build/main.o
src/main.c: In function 'create_unit_strategy':
src/main.c:62:46: error: unused parameter 'my_team' [-Werror=unused-parameter]
   62 | static void     create_unit_strategy(t_team *my_team, int warrior_count,
      |                                      ~~~~~~~~^~~~~~~
src/main.c:62:59: error: unused parameter 'warrior_count' [-Werror=unused-parameter]
   62 | static void     create_unit_strategy(t_team *my_team, int warrior_count,
      |                                                       ~~~~^~~~~~~~~~~~~
src/main.c: In function 'warrior_attack':
src/main.c:150:17: error: unused parameter 'enemy_units' [-Werror=unused-parameter]
  150 |         t_obj **enemy_units, int squad_number, int tick_counter)
      |         ~~~~~~~~^~~~~~~~~~~
src/main.c: In function 'handle_worker':
src/main.c:213:54: error: unused parameter 'enemy_units' [-Werror=unused-parameter]
  213 | static void     handle_worker(t_obj *worker, t_obj **enemy_units,
      |                                              ~~~~~~~~^~~~~~~~~~~
src/main.c: In function 'coordinate_units':
src/main.c:243:19: error: unused variable 'attack_squad' [-Werror=unused-variable]
  243 |         t_obj   **attack_squad;
      |                   ^~~~~~~~~~~~
src/main.c:241:18: error: unused variable 'curr' [-Werror=unused-variable]
  241 |         t_obj   *curr;
      |                  ^~~~
src/main.c:238:13: error: unused parameter 'warrior_count' [-Werror=unused-parameter]
  238 |         int warrior_count, int enemies_near_core)
      |         ~~~~^~~~~~~~~~~~~
src/main.c: At top level:
src/main.c:86:19: error: 'form_attack_squad' defined but not used [-Werror=unused-function]
   86 | static t_obj    **form_attack_squad(t_obj **warriors, int squad_size)
      |                   ^~~~~~~~~~~~~~~~~
